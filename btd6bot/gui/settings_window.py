...
class SettingsWindow:
    ...
    def __init__(self) -> None:
        ...
        self.resolution_width_entry = tk.Entry(
            self.settings_window, 
            width=10, 
            font=os_font
        )
        ...
        self.resolution_height_entry = tk.Entry(
            self.settings_window, 
            width=10, 
            font=os_font
        )
        ...
        self.windowed_label = tk.Label(
            self.settings_window, 
            text='Set window top left coordinate (X x Y, centered or auto)', 
            font=os_font
        )
        ...
        self.windowed_width_entry = tk.Entry(
            self.settings_window, 
            width=10, 
            font=os_font
        )
        ...
        self.windowed_height_entry = tk.Entry(
            self.settings_window, 
            width=10, 
            font=os_font
        )
        ...
        version_current_value = tk.Label(
            self.settings_window, 
            relief='ridge', 
        ...
        self.ingame_res_width_entry = tk.Entry(
            self.settings_window, 
            width=10, 
            font=os_font
        )
        ...
        self.ingame_res_height_entry = tk.Entry(
            self.settings_window, 
            width=10, 
            font=os_font
        )
        ...
        self.ocr_frequency_entry = tk.Entry(
            self.settings_window, 
            width=10, 
            font=os_font
        )
        ...
        self.verify_limit_entry = tk.Entry(
            self.settings_window, 
            width=10, 
            font=os_font
        )
        ...
        self.ocr_autoadjust_entry = tk.Entry(
            self.settings_window, 
            width=45, 
            font=os_font
        )
        ...
        self.ocr_autoadjust_button = tk.Button(
            ...
            anchor='w',
            padx=5,
            command=self._set_ocradjust_value, 
            font=os_font
        )
