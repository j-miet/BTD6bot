...
def end_round(time_limit: int = 0) -> None:
    ...
    to search current round number and wait for valid input, instead it will instantly start the next round.
    ...
    kb_mouse.kb_input(hotkeys["play/fast forward"])
    _maindata.maindata["internal"]["skip_roundcheck"] = True
    time.sleep(0.2)
