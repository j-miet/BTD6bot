...
def init_maindata(maindata_dict: dict[str, Any] = maindata) -> bool:
    ...
    temp_dict["debug"] = {
        # NOT IMPLEMENTED: debug mode for testing if static tower positions are valid
        "test_positions": False,
        # NOT IMPLEMENTED: test tower positions (even round-based e.g. Geared) and costs (TODO add round income file)
        "test_full": False,
    }
