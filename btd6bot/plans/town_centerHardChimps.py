...
def play(data):
    ...
    while round < END+1:
        ...
        if round == BEGIN:
            hero = Hero(0.2760416667, 0.2842592593)
        elif round == 8:
            sniper1 = Monkey('sniper', 0.1848958333, 0.4861111111)
            sniper1.target('strong')
        elif round == 15:
            heli1 = Monkey('heli', 0.1229166667, 0.4500000000)
        elif round == 19:
            heli1.upgrade(['1-0-0'])
        elif round == 21:
            heli1.upgrade(['2-0-0'])
            ...
            village1 = Monkey('village', 0.2276041667, 0.4175925926)
            village1.upgrade(['0-1-0'])
        elif round == 35:
            village1.upgrade(['0-2-0'])
        elif round == 36:
            heli2 = Monkey('heli', 0.1578125000, 0.3259259259)
        elif round == 37:
            ...
            glue1 = Monkey('glue', 0.2916666667, 0.4055555556)
