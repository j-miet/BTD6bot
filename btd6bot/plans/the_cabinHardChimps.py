...
def play(rounds):
    ...
    while current_round < END+1:
        ...
        if current_round == BEGIN:     
            hero = Hero(0.2848958333, 0.5453703704)
        elif current_round == 8:
            sniper1 = Monkey('sniper', 0.1734375000, 0.7796296296)
            sniper1.target('strong')
        elif current_round == 15:
            heli1 = Monkey('heli', 0.1838541667, 0.5981481481)
            ...
            village1 = Monkey('village', 0.2526041667, 0.6851851852)
            village1.upgrade(['0-1-0'])
        elif current_round == 35:
            village1.upgrade(['0-2-0'])
        elif current_round == 36:
            heli2 = Monkey('heli', 0.3286458333, 0.7481481481)
            ...
            glue1 = Monkey('glue', 0.2156250000, 0.7592592593)
