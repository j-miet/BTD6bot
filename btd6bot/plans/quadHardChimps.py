...
-Can do black border: depends on rng a bit, but should be quite consistent. Rounds 37-40, in particular 40, can leak randomly: the issue is with how quickly bot detects round change and times ability correctly, and sometimes ability is not required at all if wizard firewall is in right spot. Round 100 can also fail, which is annoying as you could fail right at the end.
"""
