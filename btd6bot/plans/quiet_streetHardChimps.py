...
def play(data):
    ...
    while round < END + 1:
        ...
        if round == BEGIN:
            hero = Hero(0.309375, 0.3574074074074)
        elif round == 8:
            wizard = Monkey("wizard", 0.309375, 0.6648148148148)
        elif round == 9:
            wizard.upgrade(["1-0-0"])
        elif round == 11:
            druid = Monkey("druid", 0.325, 0.3)
        elif round == 13:
            ...
            spike = Monkey("spike", 0.4390625, 0.5240740740741)
        elif round == 34:
