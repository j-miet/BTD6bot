...
def play(data):
    ...
    while round < END + 1:
        ...
        if round == BEGIN:
            hero = Hero(0.3046875, 0.2574074074074)
        elif round == 8:
            sniper1 = Monkey("sniper", 0.3401041666667, 0.1759259259259)
            sniper1.target("strong")
        elif round == 15:
            heli1 = Monkey("heli", 0.4036458333333, 0.2944444444444)
        elif round == 19:
            heli1.upgrade(["1-0-0"])
        elif round == 21:
            heli1.upgrade(["2-0-0"])
            ...
            village1 = Monkey("village", 0.3973958333333, 0.1388888888889)
            village1.upgrade(["0-1-0"])
        elif round == 35:
            village1.upgrade(["0-2-0"])
        elif round == 36:
            heli2 = Monkey("heli", 0.4911458333333, 0.1092592592593)
        elif round == 37:
            ...
            glue1 = Monkey("glue", 0.3463541666667, 0.1)
