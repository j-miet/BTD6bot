...
Round 99 could be cleared with anti-bloon ability, but then round 98 ability timing needs to be very precise. 
Instead, a 2-0-4 mermonkey is used which can stall fortified ddts long enough for anti-bloon to handle them.
"""
