...
def play(rounds: tuple[str, str, str, int, int, str]) -> None:
    ...
    while current_round < END+1:
        ...
        if current_round == BEGIN:     
            hero = Hero(0.3067708333333, 0.4481481481481)
        elif current_round == 8:
            sniper1 = Monkey('sniper', 0.3494791666667, 0.4907407407407)
            sniper1.target('strong')
        elif current_round == 15:
            heli1 = Monkey('heli', 0.3479166666667, 0.2277777777778)
            ...
            village1 = Monkey('village', 0.3260416666667, 0.3564814814815)
            village1.upgrade(['0-1-0'])
        elif current_round == 35:
            village1.upgrade(['0-2-0'])
        elif current_round == 36:
            heli2 = Monkey('heli', 0.2406250000000, 0.3018518518519)
            ...
            glue1 = Monkey('glue', 0.2677083333333, 0.3944444444444)
