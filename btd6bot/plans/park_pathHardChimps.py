...
def play(data):
    ...
    while round < END+1:
        ...
        if round == BEGIN:     
            ...
            sniper1 = Monkey('sniper', 0.4151041667, 0.1972222222)
            sniper1.target('strong')
        elif round == 15:
            heli1 = Monkey('heli', 0.5505208333, 0.3157407407)
        elif round == 19:
            heli1.upgrade(['1-0-0'])
        elif round == 21:
            heli1.upgrade(['2-0-0'])
            ...
            village1 = Monkey('village', 0.4770833333, 0.2027777778)
            village1.upgrade(['0-1-0'])
        elif round == 35:
            village1.upgrade(['0-2-0'])
        elif round == 36:
            heli2 = Monkey('heli', 0.5583333333, 0.0851851852)
        elif round == 37:
            ...
            glue1 = Monkey('glue', 0.4067708333, 0.3324074074)
