...
def play(data):
    ...
    while round < END+1:
        ...
        if round == BEGIN:     
            hero = Hero(0.3083333333, 0.6481481481)
        elif round == 8:
            sniper1 = Monkey('sniper', 0.2911458333, 0.5925925926)
            sniper1.target('strong')
        elif round == 15:
            heli1 = Monkey('heli', 0.3953125000, 0.8472222222)
        elif round == 19:
            heli1.upgrade(['1-0-0'])
        elif round == 21:
            heli1.upgrade(['2-0-0'])
            ...
            village1 = Monkey('village', 0.3442708333, 0.7259259259)
            village1.upgrade(['0-1-0'])
        elif round == 35:
            village1.upgrade(['0-2-0'])
        elif round == 36:
            heli2 = Monkey('heli', 0.4432291667, 0.7287037037)
        elif round == 37:
            ...
            glue1 = Monkey('glue', 0.2666666667, 0.7916666667)
