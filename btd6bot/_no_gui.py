...
class NoGui:
    ...
    def __init__(self) -> None:
        ...
        self.INFO_MESSAGE = (
            "To change any settings/hotkeys, use the gui version, make changes there and they will\n"
    ...
    def _toggle_modes(self) -> None:
        print(
            "Change event and replay modes on/off by typing 'event', 'farming' or 'replay'."
